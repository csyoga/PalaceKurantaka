\newpage
\def\krnt{\textit{Koraṇṭakapaddhati III}}
%~
%\vfill
\HalfPageImage{forprint/140_folio_42_recto_B_OF_KP_III.jpg}{}
%\vskip -10pt
...
\HalfPageImage{forprint/141_folio_42_verso_E_OF_KP_III.jpg}{\krnt, folio 42\,\RE,\,\VE.\hspace{1.4cm}}
%\vskip -10pt
...
%\begin{HalfText}
\begin{sans}
\centerline{\booktitle{koraṇṭakapaddhatiḥ ३}}
\vskip 7pt

\centerline{{\Large\bfseries śrīgaṇeśāya namaḥ}}
\vskip 7pt
...
\begin{nohyp}
\begin{eng}
\centerline{\booktitle{Koraṇṭaka\index{Korantaka@Koraṇṭaka}’s Manual III}}
\vskip 7pt
...
\begin{multicols}{2}
\begin{eng}
\Section*[The Practice]{[The Practice]}

\begin{enumerate}[nosep]
\item[1.] When first undertaking the practice, a [yogi\index{yogi}’s main] obstacle is said to be laziness. Gritting his teeth, the yogi\index{yogi} should devour laziness.\endnote{The expression \textit{dantān kaṭakaṭāyya} (literally, “gnashing the teeth”) occurs elsewhere in Sanskrit literature, where it is sometimes used to describe a person who is angry or in a rage (e.g., \textit{Rāmāyaṇa} 7.61.2, \textit{Mahābhārata} 5.159.6 [12.25], etc.). In the current context, it appears to be a metonymic expression for determined effort, hence our translation\index{Kannada!translation} “gritting the teeth.”}
...
\item[4.] And without resorting to a doctor, [a yogi\index{yogi}] should be capable of burning up diseases.  When \textit{āsana} has become steady, one should do the breath practice.
\item[5.] The [breath] practice should be done vigorously until sweat arises.\endnote{Various other texts mention that sweat (\textit{sveda}) and shaking (\textit{kampa}, mentioned in verse 7) are signs of the lowest and intermediate stages of \textit{prāṇāyāma}, respectively. Examples include \textit{Haṭhapradīpikā} 2.12 and \textit{Vivekamārtaṇḍa} 87.} And when the body is moistened by the heat, rubbing it with ashes is prescribed.\endnote{Cf.\ \textit{Koraṇṭakapaddhati I} (\textit{yadi pāto gharmeṇa saha aṅge marditavyaḥ}) and \textit{Haṭhapradīpikā} 2.13. The \textit{Haṭhapradīpikā} states that one should rub sweat into the body, but neither it nor \textit{Koraṇṭakapaddhati I} prescribe the use of ash for this.}
...
\item[7.] When trembling has arisen in the body, the [breath] practice progresses to an intermediary stage.  When the trembling has diminished, only at that time does the yogi\index{yogi}’s channels become pure.
\end{enumerate}
\vskip 7pt

\Section*[Health Benefits and Remedies]{[Health Benefits and Remedies]}
...
\item[9.] There is strength in the teeth and then a slight reddishness in the nails. Ailments, such as scabby eruptions and so on, and [other] skin diseases disappear.\endnote{The skin disease \textit{pāmā} is usually classified as a minor variety of \textit{kuṣṭha}, which is a broad category of skin diseases (e.g., \textit{Carakasaṃhitā, Cikitsāsthāna} 7.21–26). It is often translated as scabies (Meulenbeld, vol 1b, 1999: 109, note 199) but the general sense of scabies as a scabby eruption might be intended here rather than the specific disease caused by the itch mite, \textit{Sarcoptes scabiei}.}
\item[10.] With the disappearance of piles, swelling and so on, optimal health arises in the body.\endnote{The compound \textit{aṅgapāṭava}\index{angapatava@\emph{aṅgapāṭava} (also \emph{śarīrapāṭava})} is used in an early version of the \textit{Haṭhapradīpikā} (1.17) to mean optimal functioning of the body. In the \textit{Śiva\index{Siva@Śiva}\-saṃhitā} (2.35),  \textit{śarīrapāṭava} is mentioned as one of the benefits bestowed by digestive fire (\textit{vaiśvānarāgni}).} Pepper is recommended for cold ailments and Brāhmī for those of bile.
\item[11.] As is well known, [taking] the Black Oil plant\index{Black Oil plant} for wind ailments\index{wind ailments} has been taught by the great Kāki\index{Kaki@Kāki}.\endnote{\textit{Jyotiṣmatī} is usually identified as \textit{Celastrus paniculatus} \textsc{Willd} (e.g., Singh and Chunekar 1999: 171), which is commonly known as the black oil plant\index{Black Oil plant}, climbing staff tree, and intellect tree. On the possible identity of Kāki\index{Kaki@Kāki}, see the introduction (section 2.4).} Yogis recommend rice, wheat, sixty-day rice, and the like.\endnote{Both \textit{taṇḍula} and \textit{godhuma} are mentioned as wholesome foods in the \textit{Koraṇṭakapaddhati I}, and \textit{ṣaṣṭika} is recommended in \textit{Haṭhapradīpikā} 1.62.}
...
\Section*[The Yogi\index{yogi}]{[The Yogi\index{yogi}]}

\begin{enumerate}[nosep]
\item[13–14.] Marks and emblems should be worn mockingly or playfully.\endnote{We do not know of a parallel in another text for the notion of yogis wearing marks and emblems mockingly or playfully. The closest idea may be that expressed in \textit{Amanaska}\index{Amanaska} 2.34–36, which states that adopting sectarian emblems (\textit{liṅga}) is not useful in any situation for one who is self-realised and detached.} [The yogi\index{yogi} should carry] two complete black antelope skins adorned with horns, hooves, and so on; a tiger-skin garment; one made from rags and woollen blankets; a water pot made from the horn of a rhinoceros; a stringed instrument; and a book.\endnote{Since it is unlikely that a yogi\index{yogi} would be carrying a ‘head,’ the manuscript’s reading of \textit{mastakam} at the end of 14d is likely a dittographic error as the next verse begins with \textit{mastake}.}
\item[15.] Also, [the yogi\index{yogi} should wear] a twisted mass of matted locks\index{locks|see{bandhas}} on his head, free from beautiful adornments. And white ash made of cow dung should be worn on the body.
\item[16.] [He should have] a loin cloth\index{loin cloth}, a [piece of] fine cloth,\endnote{Cf.~verse 6.} and a staff made of bamboo. [The yogi\index{yogi}] desirous of success should wear sandals made of wood.
\end{enumerate}
\columnbreak

\Section*[Mantra Recitation with a Golden Brick]{[Mantra Recitation with a Golden Brick]}
...
\item[18.] He should hold a golden sacrificial brick with twelve corners. It should be endowed with as many facets and nicely decorated with a syllable [on each facet].\endnote{It seems probable that each facet contained one syllable of the twelve-syllable Vāsudeva\index{Vasudeva@Vāsudeva} mantra\index{Vasudeva mantra@Vāsudeva mantra}, which is attested in full in \textit{Koraṇṭakapaddhati I} and alluded to below.}
\item[19.] [The brick] is smeared with eight fragrant substances [and] anointed with perfumed pastes [called \textit{yakṣakardama}]. [The student] should cover it and worship\index{worship} it on an altar with fragrant flowers. 
\item[20.] Near it, he should recite the twelve-syllable mantra. It destroys enemies and increases friends and wealth.
\item[21.] And kings would undoubtedly be under his control. Satisfied, Vāsudeva\index{Vasudeva@Vāsudeva} also bestows [liberation\index{liberation} in the form of being in] his presence. 
\item[22.] Fire sacrifice is twice as effective as mantra recitation, and libation is twice as effective as fire sacrifice. The [most] exalted worship\index{worship} should be performed with vedic and tantric mantras\index{mantras}.
\item[23.] A person desirous of success should give food to Brahmins\index{Brahmins}. With devotion one should honour the wise, for this is the cause of all success.
\end{enumerate}
\vskip 7pt
...
\begin{enumerate}[nosep]
\item[24.] Thus, the \textit{mudrā}, which is secret in yoga\index{Korantaka@Koraṇṭaka!yoga} and has been revealed through practice, has been written down by Goraṇṭaka\index{Gorantaka@Goraṇṭaka} for his own sake and for awakening students.
\item[25.] Those who have understood the teachings on the secret points of virtue and have extracted the manual of Goraṇṭaka\index{Gorantaka@Goraṇṭaka} are skilled in accomplishing whatever needs to be done and have the visible protection afforded by their lords, even in the next world.
\end{enumerate}
Thus, the manual of Kuraṇṭaka\index{Kurantaka@Kuraṇṭaka} is complete.
\end{eng}
\end{multicols}
\end{nohyp}
\vskip 1cm
...
\centerline{\booktitle{ಕೊರಂಟಕಪದ್ಧತಿ ೩}}
