...
%1
%\incanum
\asana{[The yogi] should lie supine,\index{asanas@\emph{āsana}s!supine}  bind the neck with the fingers, join the elbows, touch the buttocks on the ground, extend one leg and rotate the other leg to the left and right. [This] is the \engname{Pawing the Leg like a Bull [Pose]} (\engiast{vṛṣapādakṣepa}).}
...
%2.
%\incanum
\asana{[The yogi] should lie supine,\index{asanas@\emph{āsana}s!supine} join and extend the legs, touch the buttocks on the ground, bind the neck with the hands, hold the breath and remain thus. [This] is the \engname{Iron-bar Pose} (\engiast{parighāsana}).}
...
%3.
\asana{[The yogi] should lie supine,\index{asanas@\emph{āsana}s!supine} place the elbows on the navel, extend one hand at a time, hold the nose by the thumb [of the other hand] with the gaze on it, while supporting [the position] with the region of the hips, and remain thus. [This] is the \engname{Hatchet Pose} (\engiast{paraśvāsana}).}
...
%5.
\asana{[The yogi] should lie supine.\index{asanas@\emph{āsana}s!supine} Putting one foot on the [back of the] neck, he should place the other hand on the root of the ear. Having placed the elbow of this arm on the ground, while making the other hand and leg straight, he should remain thus [and then repeat it with the other foot on the neck]. [This] is the \engname{Goad Pose} (\engiast{aṅkuśāsana}).}
...
\begin{multicols}{2}
%13.
\asana{[Staying] as though in the Diagonal Boat [Pose] and supporting [himself] with the neck, back and elbows on the ground, [the yogi] should take up the toes of the feet, pointing [them] towards the head. [This] is the \engname{Banner Pose}\index{Banner Pose} (\engiast{dhvajāsana}).}
...
%18. 
\asana{While in the Cane Pose, [the yogi] should release his hands and feet, take [them] upwards [and] press the ground with his backbone. [This] is the \engname{Ball Pose}\index{Ball Pose} (\engiast{kandukāsana}).}
...
%23.
\asana{Lying prone,\index{asanas@\emph{āsana}s!prone} [the yogi] should place the navel on the ground and support [himself on] the ground with the forearms like pillars, join the lips, make the [sound] \textsc{sūṃ} like a flute, and remain thus. [This] is the \engname{Lizard Pose} (\engiast{saraṭāsana}).}
...
%24.
\asana{Lying prone,\index{asanas@\emph{āsana}s!prone} [the yogi] should raise up the elbows by the sides [of the body,] and support [himself on] the ground with the palms of the hands. He should fly up again and again. [This] is the \engname{Fish Pose} (\engiast{matsyāsana}).}
...
%27.
\asana{[The yogi] should do the elephant pose, bending one leg at a time. [This] is the \engname{Bear Pose}\index{Bear Pose} (\engiast{ṛkṣāsana}).}
...
%31.
\begin{multicols}{2}
\asana{While in the Elephant Pose, [the yogi] should raise both legs into the air and  touch the ground with the head. [This] is the \engname{Goat Pose} (\engiast{ajāsana})\index{ajasana@ajāsana}.}
...
%38.
\begin{multicols}{2}
\asana{Having placed one foot on [the back of] the neck, [the yogi] should fix the other foot above it, support [the body] with the palms of the hands [on the ground] and remain thus. [This] is the \engname{Wood-sparrow Pose} (\engiast{araṇyacaṭakāsana})\index{aranyacatakasana@\emph{araṇyacaṭakāsana}}.}
...
%41
\begin{multicols}{2}
\asana{[The yogi] should lie prone,\index{asanas@\emph{āsana}s!prone} sit up straight, support [himself ] with the soles of the feet on the
...
%46
\asana{Lying prone,\index{asanas@\emph{āsana}s!prone} [the yogi] should place the hands on the buttocks, extend the legs, join [them]
...
%47
\asana{[The yogi] should lie prone,\index{asanas@\emph{āsana}s!prone} cross the heels behind him, hold the big toes with the hands, and roll
[around]. [This] is the \engname{Prone Pose}\index{asanas@\emph{āsana}s!prone} (\engiast{nyubjāsana}).}{ಹೊಟ್ಟೆ ಕೆಳಗೆ ಮಾಡಿ ಮಲಗಿ, ಹಿಮ್ಮಡಿಗಳನ್ನು ಹಿಂದಕ್ಕೆ ಕತ್ತರಿ ಆಕಾರದಲ್ಲಿ ಜೋಡಿಸಿ, ಕೈಗಳಿಂದ ಕಾಲ್ಬೆರಳುಗಳನ್ನು ಹಿಡಿದು ಉರುಳಬೇಕು. ಇದನ್ನು  \tbf{ನ್ಯುಬ್ಜಾಸನ} ಎನ್ನಲಾಗುತ್ತದೆ.}
\vskip 0.5cm

\insimgcol{HRCP/050_folio_14_recto_47_E_PRONE.jpg}

\asananamestmp{nyubjāsanaṃ}{Prone Pose}{ನ್ಯುಬ್ಜಾಸನ}\index{asanas@\emph{āsana}s!prone}
\end{fullpagebox}
\end{paracol}
\newpage
...
\begin{eng}
\prtheading[Stationary Poses]{Now, the Stationary Poses.}\index{asanas@\emph{āsana}s!stationary}
\end{eng}
\vskip 7pt
...
\engname{Bound Lotus Pose} (\engiast{baddhapadmāsana}\index{baddhapadmasana@\emph{baddhapadmāsana}}).}{ಒಂದು ಪಾದವನ್ನು ಎದುರಿನ ತೊಡೆಯ ಮೇಲೂ, ಇನ್ನೊಂದು ಪಾದವನ್ನು ಮತ್ತೊಂದು ತೊಡೆಯ ಮೇಲೂ ಇರಿಸಿ (ಪದ್ಮಾಸನ), ಬೆನ್ನಿನ ಹಿಂದಿನಿಂದ ಕೈಗಳನ್ನು ಕತ್ತರಿ ಆಕಾರದಲ್ಲಿ ತಂದು ಕಾಲ್ಬೆರಳುಗಳನ್ನು ಹಿಡಿಯಬೇಕು. ಇದು \tbf{ಬದ್ಧ ಪದ್ಮಾಸನ}.}
\end{multicols}
\end{adjustwidth}
...
%56
\asana{Lying prone,\index{asanas@\emph{āsana}s!prone} [the yogi] should place the heels on the neck. Holding both ankles with the hands, he
...
\begin{eng}
\prtheading[Standing Poses]{Now, the Standing Poses.}\index{asanas@\emph{āsana}s!standing}
\end{eng}
\vskip 7pt
...
\asananamestmp{utpīḍāsanaṃ}{Pressure Pose}{ಉತ್ಪೀಡನಾಸನ}
\vskip 0.5cm
...
%76
\asana{Joining the heels together [while] standing,\index{asanas@\emph{āsana}s!standing} [the yogi] should take the buttocks to the level of the
...
[the yogi] should stand [and] sit. It should be done thus again and again. [This] is the \engname{Half-moon [Pose]} (\engiast{ardha\-candra}).}{ಒಂದು ಪಾದವನ್ನು ನೆಲದ ಮೇಲಿಟ್ಟು, ಇನ್ನೊಂದು ಪಾದದ ಅಡಿಯನ್ನು ನೆಲದ ಮೇಲಿಟ್ಟ ಕಾಲಿನ ತೊಡೆಯ ಮೇಲಿರಿಸಬೇಕು. ಈ ಸ್ಥಿತಿಯಲ್ಲೇ ಕುಳಿತುಕೊಳ್ಳುವುದು ಮತ್ತು ಏಳುವುದು—ಹೀಗೆ ಪದೇ ಪದೇ ಮಾಡಬೇಕು. ಇದು \tbf{ಅರ್ಧಚಂದ್ರಾಸನ}.}
\end{multicols}
\end{adjustwidth}
...
%80
\begin{multicols}{2}
\asana{While standing,\index{asanas@\emph{āsana}s!standing} [the yogi] should press the heel [of one foot] on the loin of the other [leg], sit
...
%84
\begin{multicols}{2}
\asana{Standing\index{asanas@\emph{āsana}s!standing} at a distance of three cubits from a wall, [the yogi] should touch his chest on the wall,
...
%89
\asana{Standing\index{asanas@\emph{āsana}s!standing} straight, [the yogi] should hold up the arms. Jumping up again and again, he should bring
...
\asananamestmpscale{paroṣṇyāsanaṃ}{Cockroach Pose}{ಪರೋಶ್ಣ್ಯಾಸನ}{0.85}
\vskip 0.5cm
...
\asananamestmpscale{daṇḍāsanaṃ}{Stick Pose}{ದಂಡಾಸನ}{0.78}
\vskip 0.5cm
...
\asananamestmp{bhārāsanaṃ}{Weight Pose}{ಭಾರಾಸನ}
\end{fullpagebox}
\switchcolumn
\begin{fullpagebox}{\textheight}{c}{\columnwidth}%
\begin{sans}
...
%97
\asana{\raggedright Having placed the buttocks on a [horizontal] rope, [the yogi] should become [straight and] rigid
like a stick. [This] is the \engname{Weight Pose} (\engiast{bhārāsana}).}
...
%98
\asana{\raggedright Holding a [vertical] rope with the hands, [the yogi] should climb up it. [This] is \engname{Nārada’s Pose}
...
%99
\asana{\raggedright Assuming the Lotus Pose and holding a [vertical] rope with the hands, [the yogi] should climb up
...
%100
\asana{\raggedright Assuming the Cock Pose and holding a [vertical] rope with the hands, [the yogi] should climb up
it. [This] is the \engname{Spider Pose} (\engiast{ūrṇanābhyāsana}).}
...
\asananamestmp{ūrṇanābhyāsanaṃ}{Spider Pose}{ಊರ್ಣನಾಭ್ಯಾಸನ}
\end{fullpagebox}
\end{paracol}}
...
\asananamestmp{śukāsanaṃ}{Parrot Pose}{ಶುಕಾಸನ}
\end{fullpagebox}
\switchcolumn
\begin{fullpagebox}{\textheight}{c}{\columnwidth}%
\begin{sans}
...
%101
\asana{\raggedright Holding a [vertical] rope with the fists, [the yogi] should put the soles of the feet on the [fists]. He
should remain thus. [This] is the \engname{Parrot Pose} (\engiast{śukāsana}).}
...
%102
\asana{\raggedright Holding a [vertical] rope with the big toes above and the hands below, [the yogi] should climb up
...
\asananamestmp{vṛntāsanaṃ}{Grub Pose}{ವೃಂತಾಸನ}
\end{fullpagebox}
\switchcolumn
\begin{fullpagebox}{\textheight}{c}{\columnwidth}%
\begin{sans}
...
%103
\asana{\raggedright Having held a [vertical] rope with one fist, [the yogi] should climb up it. [This] is the \engname{Grub Pose}
...
%104
\asana{\raggedright Passing the fists through the thighs and knees, [the yogi] should hold two [vertical ropes] with
...
\asananamestmp{krauñcāsanaṃ}{Crane Pose}{ಕ್ರೌಂಚಾಸನ}
\end{fullpagebox}
\end{paracol}}
...
\asananamestmp{varāhāsanaṃ}{Boar Pose}{ವರಾಹಾಸನ}
...
\engname{Boar Pose} (\engiast{varāhāsana}).}
{ಮೊಣಕೈ ಮತ್ತು ಮೊಣಕಾಲುಗಳನ್ನು ನೆಲಕ್ಕೆ ಊರಿ, ತಲೆಯನ್ನು ಕೈಗಳ ಮೇಲಿಟ್ಟು, ಹಿಮ್ಮಡಿಗಳನ್ನು ಪೃಷ್ಠಕ್ಕೆ ತಾಗಿಸಿ ಹಾಗೆಯೇ ಇರಬೇಕು. ಇದು \tbf{ಹಂದಿಯ ಭಂಗಿ} (\tit{ವರಾಹಾಸನ}).}
\end{paracol}
\vskip 0.8cm
...
\asananamestmpscale{yonyāsanaṃ}{Perineum Pose}{ಯೋನ್ಯಾಸನ}{0.88}
\vskip 0.5cm
...
other thigh, [the yogi] should sit upright. [This] is the \engname{Lucky Mark Pose} (\engiast{svastikāsana}).}
...
%109
\asana{\raggedright Pressing the perineal seam with one heel and the penis with the heel of the other foot, [the yogi]
should sit upright. [This] is the \engname{Thunderbolt Pose} (\engiast{vajrāsana}).}
...
%110
\asana{\raggedright Supporting himself with the soles of the feet on the ground, [the yogi] should take his knees to the
base of his ears. [This] is the \engname{Squatting Pose} (\engiast{utkaṭāsana}).}
...
\asananamestmp{śuktyāsanaṃ}{Oyster Pose}{ಶುಕ್ತ್ಯಾಸನ}
\vskip 0.5cm
...
%111
\asana{Placing the heels on the navel, [the yogi] should join the outsides of the lower legs. [This] is the \engname{Oyster Pose} (\engiast{śuktyāsana}).}
...
%112
\asana{[The yogi] should remain like a corpse on the ground. [This] is the \engname{Corpse Pose} (\engiast{śavāsana}).}
...
%113
\begin{multicols}{2}
\asana{[The yogi] should stretch out the legs. [This] is \engname{Stretching Out [the Legs] Pose} (\engiast{uttānāsana}).}
...
yogi] whose eyes are half open should remain thus. [This] is the \engname{Comfortable Pose} (\engiast{sukhāsana}).}
