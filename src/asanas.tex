...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=center, inner sep=0pt] at (current page.center) {
        \includegraphics[width=\paperwidth, height=\paperheight]{sample/041_folio_11_verso_38.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
    % Your "Full Page" content here
    \node[anchor=center, inner sep=0pt] at (current page.center) {
        \includegraphics[width=\paperwidth, height=\paperheight]{sample/057_folio_15_verso_54.jpg}
    };
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
    % Your "Full Page" content here
    \node[anchor=center, inner sep=0pt] at (current page.center) {
        \includegraphics[width=\paperwidth, height=\paperheight]{sample/094_folio_25_recto_91.jpg}
    };
\end{tikzpicture}
\newpage
...
\begin{tikzpicture}[remember picture, overlay]
    % Your "Full Page" content here
    \node[anchor=center, inner sep=0pt] at (current page.center) {
        \includegraphics[width=\paperwidth, height=\paperheight]{sample/107_folio_28_recto_104_E_ROPES.jpg}
    };
\end{tikzpicture}
