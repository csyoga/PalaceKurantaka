...
%23.
\asana{Lying prone, [the yogi] should place the navel on the ground and support [himself on] the ground with the forearms like pillars, join the lips, make the [sound] \textsc{sūṃ} like a flute, and remain thus. [This] is the \engname{Lizard Pose} (\engiast{saraṭāsana}).}
