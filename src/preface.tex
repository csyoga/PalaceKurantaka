...
\begin{sans}
\centerline{\booktitle{koraṇṭakapaddhatiḥ}}
\bigskip
...
\begin{eng}
\centerline{\booktitle{Koraṇṭaka’s Manual [of Haṭhayoga]}}
\vskip 7pt
...
\begin{multicols}{2}
\begin{eng}
Those afflicted by the pain of transmigration, those excessively attached to sense objects, those obsessed with women, those fallen from caste, and [even] those who perform the most egregious actions; for their sake this manual on the practice of Haṭha[yoga] has been composed by Kapālakuraṇṭaka. The topics in it and the techniques of the practice are written [here].
\vskip 7pt

\Section[Characteristics of the Yogi’s Hut]{Characteristics of the [Yogi’s] Hut}

The measurement is four forearm lengths high and wide. A hut [smeared] with ash, for the practice of seals (\textit{mudrā}). A hut [made] of reddish soil, for the practice of postures (\textit{āsana}). A hut [smeared] with plaster, for the practice of the [six cleansing techniques,] such as the enema (\textit{basti}).\index{basti@\emph{basti}}  A hut with an animal skin, such as that of a tiger, for lying down.  A hut with a cotton cloth and the like, for \textit{vajroli}. A hut three bow-lengths high and one bow-length wide, for the practice of postures [requiring a rope], such as the posture [of Climbing up to] Heaven.  There should be a place that is nearby, hidden and closed off for excreting faeces and so on. For bathing, there should be a stream of water free of people.
\vskip 7pt

\Section{Characteristics of the Behavioural Codes (\textit{yama}) and Observances (\textit{niyama})}

Non-violence, truthfulness, not stealing, non-attachment, shame, not accumulating [goods], belief, celibacy, silence, steadiness, patience and fearlessness [are the  \textit{yama}s]. Purity, reciting mantras, asceticism,\index{asceticism} [performing] a fire \mbox{sacrifice,} confidence, hospitality, worship of me (i.e., god), travelling to sacred places, striving to help others, satisfaction and serving the teacher [are the \textit{niyama}s].\endnote{\hspace*{.01cm} Both verses were borrowed from the \textit{Bhāgavata\-purāṇa} (11.19.33–34).  In their original context, the compound \textit{madarcana} means ‘worship of me (i.e., Kṛṣṇa).’}

\textbf{Non-violence} is not causing suffering to others through body, speech or thought. \textbf{Truthfulness} is speech that is factual, does not cause harm, does not cause agitation, and is beneficial. \textbf{Not stealing} is the absence of desire for the possessions of others in body, mind and speech. \textbf{Non-attachment} is the absence of affection for people who are opposed to the practice [of yoga]. \textbf{Shame} is compunction over righteous and unrighteous [actions] that destroy one’s practice [of yoga]. \textbf{Not accumulating} is not acquiring goods other than those needed for the practice [of yoga]. \textbf{Belief} is confidence in the scriptures of Matsyendra, Gorakṣa, Kāki, Kāpālika, and other [\textit{siddha}s].\endnote{On Kāki, see section 2.4 of the Introduction.} \textbf{Celibacy} is the non-emission of [even] a drop of semen through the penis, and the drawing in of female generative fluid and [other substances through the urethra]. \textbf{Silence} is the avoidance of talk about worldly matters. \textbf{Steadiness} is the stillness of mind [brought about] by not worrying about caring for a wife, son and [family]. \textbf{Patience} is that forbearance [required] when physical and mental suffering is caused by thieves, kings, and wicked people, and when one has the power to punish them. \textbf{Fearlessness} is freedom from fear as a result of knowing that the body, as the locus of ego, and one’s sons and houses, as the seat of the sense of ownership, etc., are impermanent, and that the self, which is truth, consciousness, and bliss, is permanent.

\textbf{Purity} is purification of the body through [cleansing techniques], such as enemas, swallowing a strip of cloth, and emesis; purification of speech through singing the names of god; and purification of the mind through meditating on god. 

\textbf{Mantra recitation} is the frequent repetition of the mantra of the deity to be worshipped. \textbf{Asceticism}\index{asceticism} is carrying out one’s religious duty (\textit{svadharma}). A \textbf{fire sacrifice} is the daily fire sacrifice for householders, celibate students and forest hermits;  for ascetics, Brahmins only in name, women, and the like, it is the fire sacrifice that is an ancillary of the worship of god in [scriptures, such as] Vaiṣṇava Tantras. \textbf{Confidence} is eagerness to perform the rules taught in scripture. \textbf{Hospitality} is honouring those who have practised  methods, such as Haṭhayoga, as their own path. [\textbf{Worship of me}] is worshipping god, [that is,] compassion for all beings, complete contentment with whatever one has, and seeing the self in all things. \textbf{Travelling to sacred sites} is travelling from place to place for the sake of seeing those who have perfected the practice [of yoga].  \textbf{Striving to help others} is effort directed at [helping] students succeed in the practice.  \textbf{Satisfaction} is contentment with what one obtains by chance. \textbf{Serving the teacher} is securing the favour of a teacher who is deeply versed in scripture and the experience [of yoga].
\vskip 7pt
...
\begin{kan}
\centerline{\booktitle{ಕಪಾಲ ಕುರಂಟಕನ ಹಠಯೋಗ ಪದ್ಧತಿಯ ಕೈಪಿಡಿ}}
\medskip
